...
namespace Core.UI
{
    ...
    public class Joystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
    {
        ...
        [SerializeField]
        private bool _isSnapX;

        [SerializeField]
        private bool _isSnapY;
        ...
        protected virtual void Start()
        {
            ...
            if (_canvas == null)
            {
                DebugSafe.LogError("The Joystick is not placed inside a canvas");
            }
        ...
        protected Vector2 ScreenPointToAnchoredPosition(Vector2 screenPosition)
        {
            ...
            if (RectTransformUtility.ScreenPointToLocalPointInRectangle(_baseRect, screenPosition, _camera, out localPoint))
            {
                ...
                return localPoint - (_background.rectTransform.anchorMax * _baseRect.sizeDelta) + pivotOffset;
            }
